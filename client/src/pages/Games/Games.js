...
import { Jumbotron, Row, Col, Navbar, NavItem, SideNav, SideNavItem, Modal, List, ListItem, Collapsible, CollapsibleItem, Collection, CollectionItem, Badge, Input, Button, Table, Container } from 'react-materialize';
