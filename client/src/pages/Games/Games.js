                ...
                return (
                  <ListItem key={game._id}>
                    ...
                    <Table className="center gameInfo">
                      <thead>
                        <tr>
                          <th data-field="id" className="center">
                            Sport
                          </th>
                          <th data-field="name" className="center">
                            Date
                          </th>
                          <th data-field="name" className="center">
                            Time
                          </th>
                          <th data-field="price" className="center">
                            Male | Female | Co-Ed
                          </th>
                        </tr>
                      </thead>
                        ...
                        >
                          <div className="container">
                            <Row>
                              ...
                              <SimpleMap lat={39.9205411} lng={-105.0866504} />
                            </Row>
                          </div>
                        </Modal>
                        <p>Location</p>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <Button
                                      flat
                                      onClick={() =>
                                        this.sendMail(game.authorEmail)
                                      }
                                    >
                                      {game.author}
                                    </Button>
